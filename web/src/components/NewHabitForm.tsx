...
export function NewHabitForm() {
    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            <div className="flex flex-col gap-2 mt-3">
                {availableWeekDays.map((weekDay, index) => {
                    ...
                    >
                        ...
                        group-data-[state=checked]:border-green-500 transition-colors group-focus:ring-2  group-focus:ring-violet-700  group-focus:ring-offset-2  group-focus:ring-offset-background'>
                        <Checkbox.Indicator>
            ...
            <button type="submit" className="mt-6 rounded-lg p-4
