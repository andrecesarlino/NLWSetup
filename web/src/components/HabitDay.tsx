...
export function HabitDay({defaultCompleted = 0,amount = 0, date}: HabitDayProps) {
    ...
    //monitorar os completados para mudar a barra e a cor
    function handlCompletedChanged(completed: number) {
    ...
    return (
        ...
        <Popover.Portal>
            <Popover.Content className='min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col'>
                ...
                <HabitsList date={date} onCompletedChanged={handlCompletedChanged}/>
